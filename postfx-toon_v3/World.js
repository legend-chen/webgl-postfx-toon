...
var loader = new Sequence(onResourcesReady);
    loader._addSource("vertex.vsh");
    loader._addSource("fragment.fsh");
...
//         var h3 = "#ifdef GL_ES\nprecision lowp float;\n#endif\n";
        ...
        program1.texture0 = create_texture(image);

        gl.activeTexture(gl.TEXTURE0);
        gl.bindTexture(gl.TEXTURE_2D, program1.texture0);

        gl.useProgram(program1);

        program1.edge_thres = gl.getUniformLocation(program1, "edge_thres");
        program1.edge_thres2= gl.getUniformLocation(program1, "edge_thres2");
        program1.tex0       = gl.getUniformLocation(program1, "tex0");
        program1.resolution = gl.getUniformLocation(program1, "iResolution");
        program1.mouse_x_offset = gl.getUniformLocation(program1, "mouse_x_offset");
        program1.position   = gl.getAttribLocation(program1, 'position');

        gl.uniform1f(program1.edge_thres, 0.2);
        gl.uniform1f(program1.edge_thres2, 5.0);
        gl.uniform1i(program1.tex0, 0);
        gl.uniform2f(program1.resolution, stageWidth, stageHeight);
    ...
    function onDraw()
    {
        ...
        gl.uniform1f(program1.mouse_x_offset, mMouseOffset/stageWidth);
        ...
        gl.bindBuffer(gl.ARRAY_BUFFER, program1.mVBO_Tri);
        gl.vertexAttribPointer(program1.position, 2, gl.FLOAT, false, 0, 0);
        gl.enableVertexAttribArray(program1.position);
